...
\label{fig:foreground}
	\subfigure[Vordegrundmaske, graue Bereiche wurden als Schatten erkannt]{\includegraphics[width=0.2\textwidth]{trainds01_foregroundmask}}
	\subfigure[Originalbild]{\includegraphics[width=0.2\textwidth]{trainds01_original}}
	\caption{Ergebnis der Backfroundsubstraction}
\end{figure}
