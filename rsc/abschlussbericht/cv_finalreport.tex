...
%\centering
%\includegraphics[width=5cm]{trainds01_foregroundmask}
%%\caption{Bild1}
%\label{Bild1}
%\end{minipage}
%\hfill
%\begin{minipage}[hbt]{5cm}
%\centering
%\includegraphics[width=5cm]{trainds01_original}
%%\caption{Bild2}
%\label{Bild2}
%\end{minipage}
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.23\textwidth}
		...
		\subcaption{Vordergrundmaske, graue Bereiche wurden als Schatten erkannt}
		\label{fig:sub1}
	\end{subfigure}	
